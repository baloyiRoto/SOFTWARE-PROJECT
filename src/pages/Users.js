...
function Users({ users, setUsers, nextUserID, setNextUserID }) {
  ...
  const addUser = () => {
    ...
    const newUser = { userID: nextUserID, username: username.trim(), email: email.trim(), role };
  ...
  const saveEdit = () => {
    ...
    setUsers(users.map(u => u.userID === editUser.userID ? editUser : u));
    setEditOpen(false);
      ...
      <div className="layout">
        ...
        <div className="card">
          ...
          <div className="field"><label>Username *</label>
            <input type="text" placeholder="e.g. boipelo_m" value={username}
              onChange={e => setUsername(e.target.value)} /></div>

          <div className="field"><label>Email Address *</label>
            <input type="email" placeholder="student@ac.za" value={email}
